...
filename <- paste0("high_setting_2(rho=", rho,")", ".txt")
sink(filename)
round(output2, 4)
...
filename1 <- paste0("(MSEy & RMSEy & MAEy)high_setting_2(rho=", rho,")", ".csv")
write.csv(cbind(MSEy, RMSEy, MAEy), filename1, row.names = FALSE)

filename2 <- paste0("(MSEb & RMSEb  & MAEb)high_setting_2(rho=", rho,")", ".csv")
write.csv(cbind(MSEb, RMSEb, MAEb), filename2, row.names = FALSE)

filename3 <- paste0("cerit high_setting_2(rho=", rho,")", ".csv")
write.csv(cbind(recerit,uncerit), filename3, row.names = FALSE)

filename4<- paste0("RE high_setting_2(rho=", rho,")", ".csv")
write.csv(rebeta, file = filename4, row.names = FALSE)

filename5<- paste0("Un high_setting_2(rho=", rho,")", ".csv")
write.csv(unbeta, file = filename5, row.names = FALSE)

filename6<- paste0("NONz high_setting_2(rho=", rho,")", ".csv")
